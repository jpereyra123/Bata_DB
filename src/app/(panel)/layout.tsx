        ...
        <SessionProvider>
            <div style={{ display: "flex", minHeight: "100vh" }}>
                <div style={{ width: 240, background: "#18181c", borderRight: "1px solid #2e2e38", height: "100vh", position: "fixed", padding: "24px 12px" }}>
                    ...
                    <a href="/alumnos" style={{ display: "block", padding: "9px 12px", borderRadius: 8, textDecoration: "none", color: "#9b9aaa", fontSize: 14 }}>Alumnos</a>
                    <a href="/usuarios" style={{ display: "block", padding: "9px 12px", borderRadius: 8, textDecoration: "none", color: "#9b9aaa", fontSize: 14, marginTop: 4 }}>
                        Usuarios
                    </a>
                </div>
